...
const Index = () => {
  ...
  return (
    <Layout
      ...
      pageDescription="Stay updated with the latest news, events, and official announcements from the Ikosi-Ejinrin LCDA."
    >
      <div className="bg-sky-50 dark:bg-slate-900 min-h-screen py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 px-4 animate-[fade-in_0.5s_ease-out]">
            <h1 className="text-5xl md:text-6xl font-serif font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight">News</h1>
